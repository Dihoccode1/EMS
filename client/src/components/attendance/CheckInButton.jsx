...
// Bạn có thể xóa dòng import { isCookie } từ react-router-dom nếu không dùng tới

const CheckInButton = ({ todayRecord, onAction }) => {
  const [loading, setLoading] = useState(false);

  // Fix 1: Đưa biến này ra ngoài phạm vi global của component
      ...
      >
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <p className="text-xs opacity-80">
            {isCheckedIn ? "Click to end your shift" : "Start your shift"}
          </p>
        </div>
      </button>
    </div>
